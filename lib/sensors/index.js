...
import TcpClientPullSensor from "./tcp/TcpClientPullSensor";
import TcpClientPushSensor from "./tcp/TcpClientPushSensor";
    ...
    for (let i = 0; i < sensors.length; i++)
    {
        if (sensors[i] === undefined) {
            ...
            try
            {
                ...
                else if (s.meta._monitor.mode === "tcp")
                {
                    sensor = new TcpClientPullSensor(s);
                }
                else if (s.meta._monitor.mode === "tcp-push")
                {
                    sensor = new TcpClientPushSensor(s);
                }
                else
                {
