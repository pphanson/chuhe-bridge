...
import serverTcp from "../../server/tcpServer";
import Sensor from "../Sensor";

export default class TcpServerPullSensor extends Sensor {
    constructor(config) {
        super(config);
        this.initMonitor();
    }
    ...
    initMonitor() {
        ...
        serverTcp.on(`${this.id}:data`, function(e) {
            console.log(222222222);
            let value = this.format(e.data);
            console.log(`sensor-${this.id} recieved data: ${e.data}, ${JSON.stringify(value)}`);
