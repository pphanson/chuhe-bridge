...
class ServerSocket extends events.EventEmitter
{
    constructor()
    {
        ...
        this._udpServerPort5681 = dgram.createSocket('udp4');  //称重系统数据发送至5682端口
        ...
        {
            console.log('udp server is listening on port ' + dtu[3].port);
        }.bind(this));

        this._udpServerPort5681.bind(dtu[3].port);
    }
